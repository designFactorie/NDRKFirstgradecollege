...
export default function Courses() {
    return (
        <main id="main-content" tabIndex={-1} className="page-shell ">
            ...
            <header className="page-hero hero-banner hero-centered">
                ...
                <div className="hero-container max-w-7xl mx-auto px-8 relative z-10 text-center">
                    ...
                    <h1 className="font-headline text-4xl md:text-6xl font-bold mb-8 leading-tight text-white">Explore Our <br className="hero-break" />Courses</h1>
            ...
            <section className="py-24 bg-surface-container-low">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        {/* BCA Banner */}
                        <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-10 flex flex-col shadow-[0px_20px_40px_rgba(25,28,29,0.06)] border border-outline-variant/20 hover:-translate-y-2 transition-transform duration-500">
                            <span aria-hidden="true" className="material-symbols-outlined text-4xl text-secondary mb-6">terminal</span>
                            <h2 className="font-serif text-2xl md:text-4xl text-primary mb-4">Bachelor of Computer Application</h2>
                            ...
                            <div className="flex flex-wrap gap-4 mt-auto">
                                <ActionButton program="BCA"  className="bg-primary text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-secondary transition-colors text-center inline-block">Apply Now</ActionButton>
                                <ActionButton resource="subjects" className="outline outline-1 outline-primary text-primary px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-colors">Download Subjects</ActionButton>
                            </div>
                        </div>

                        {/* BCom Banner */}
                        <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-10 flex flex-col shadow-[0px_20px_40px_rgba(25,28,29,0.06)] border border-outline-variant/20 hover:-translate-y-2 transition-transform duration-500 relative overflow-hidden">
                            <span aria-hidden="true" className="material-symbols-outlined text-4xl text-secondary mb-6 relative z-10">account_balance</span>
                            ...
                            <div className="flex flex-wrap gap-4 mt-auto relative z-10">
                                <ActionButton program="B.Com"  className="bg-primary text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-secondary transition-colors text-center inline-block">Apply Now</ActionButton>
                                <ActionButton resource="subjects" className="outline outline-1 outline-primary text-primary px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-colors">Download Subjects</ActionButton>
                            </div>
                            {/* Decorative element */}
                        ...
                        {/* MCom Banner */}
                        <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-10 flex flex-col shadow-[0px_20px_40px_rgba(25,28,29,0.06)] border border-outline-variant/20 hover:-translate-y-2 transition-transform duration-500 relative overflow-hidden">
                            <span aria-hidden="true" className="material-symbols-outlined text-4xl text-secondary mb-6 relative z-10">analytics</span>
                            ...
                            <div className="flex flex-wrap gap-4 mt-auto relative z-10">
                                <ActionButton program="M.Com"  className="bg-primary text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-secondary transition-colors text-center inline-block">Apply Now</ActionButton>
                                <ActionButton resource="subjects" className="outline outline-1 outline-primary text-primary px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-colors">Download Subjects</ActionButton>
                            </div>
                            {/* Decorative element */}
                        ...
                        {/* BBA Banner */}
                        <div className="bg-surface-container-lowest rounded-2xl p-6 md:p-10 flex flex-col shadow-[0px_20px_40px_rgba(25,28,29,0.06)] border border-outline-variant/20 hover:-translate-y-2 transition-transform duration-500">
                            <span aria-hidden="true" className="material-symbols-outlined text-4xl text-secondary mb-6">business_center</span>
                            <h2 className="font-serif text-2xl md:text-4xl text-primary mb-4">Bachelor of Business Administration</h2>
                            <p className="text-slate-600 leading-relaxed mb-8 flex-grow">
                            ...
                            <div className="flex flex-wrap gap-4 mt-auto">
                                <ActionButton program="BBA"  className="bg-primary text-white px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-secondary transition-colors text-center inline-block">Apply Now</ActionButton>
                                <ActionButton resource="subjects" className="outline outline-1 outline-primary text-primary px-6 py-3 rounded-full text-xs font-bold uppercase tracking-widest hover:bg-primary hover:text-white transition-colors">Download Subjects</ActionButton>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-surface">
                <div className="max-w-4xl mx-auto px-8">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="font-serif text-3xl md:text-5xl text-primary mb-6 italic">How the Program Works</h2>
                        <div className="w-16 h-1 bg-tertiary mx-auto"></div>
                    </div>

                    <div className="space-y-6">
                        {/* BCom Curriculum */}
                        <details id="curriculum-bcom" className="group bg-surface-container-lowest rounded-xl shadow-[0px_10px_30px_rgba(25,28,29,0.04)] border border-outline-variant/20 [&_summary::-webkit-details-marker]:hidden" open>
                            <summary className="flex items-center justify-between p-6 md:p-8 cursor-pointer list-none gap-2 md:gap-4 hover:bg-surface-container/50 transition-colors rounded-xl">
                                <div className="flex items-center gap-4">
                                    <span className="w-8 h-8 rounded-full bg-primary-container text-white flex items-center justify-center font-bold text-sm shrink-0">1</span>
                                    <span className="font-bold text-xl text-primary font-headline">Bachelor of Commerce</span>
                                </div>
                                <span aria-hidden="true" className="material-symbols-outlined transition-transform group-open:rotate-180 text-secondary shrink-0">expand_more</span>
                            </summary>
                            <div className="px-6 md:px-8 pb-8 text-slate-600 leading-relaxed pt-2 ml-4 md:ml-12 text-sm md:text-base">
                        ...
                        {/* MCom Curriculum */}
                        <details id="curriculum-mcom" className="group bg-surface-container-lowest rounded-xl shadow-[0px_10px_30px_rgba(25,28,29,0.04)] border border-outline-variant/20 [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex items-center justify-between p-6 md:p-8 cursor-pointer list-none gap-2 md:gap-4 hover:bg-surface-container/50 transition-colors rounded-xl">
                                <div className="flex items-center gap-4">
                                    <span className="w-8 h-8 rounded-full bg-primary-container text-white flex items-center justify-center font-bold text-sm shrink-0">2</span>
                        ...
                        {/* BBA Curriculum */}
                        <details id="curriculum-bba" className="group bg-surface-container-lowest rounded-xl shadow-[0px_10px_30px_rgba(25,28,29,0.04)] border border-outline-variant/20 [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex items-center justify-between p-6 md:p-8 cursor-pointer list-none gap-2 md:gap-4 hover:bg-surface-container/50 transition-colors rounded-xl">
                                <div className="flex items-center gap-4">
                                    <span className="w-8 h-8 rounded-full bg-primary-container text-white flex items-center justify-center font-bold text-sm shrink-0">3</span>
                        ...
                        {/* BCA Curriculum */}
                        <details id="curriculum-bca" className="group bg-surface-container-lowest rounded-xl shadow-[0px_10px_30px_rgba(25,28,29,0.04)] border border-outline-variant/20 [&_summary::-webkit-details-marker]:hidden">
                            <summary className="flex items-center justify-between p-6 md:p-8 cursor-pointer list-none gap-2 md:gap-4 hover:bg-surface-container/50 transition-colors rounded-xl">
                                <div className="flex items-center gap-4">
                                    <span className="w-8 h-8 rounded-full bg-primary-container text-white flex items-center justify-center font-bold text-sm shrink-0">4</span>
                ...
                <div className="max-w-7xl mx-auto px-8 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="font-serif text-4xl md:text-7xl text-white mb-8">The NDRK <br /><span className="italic text-secondary">Difference.</span></h2>
