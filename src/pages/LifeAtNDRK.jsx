...
export default function LifeAtNDRK() {
    return (
        <main id="main-content" tabIndex={-1} className="page-shell ">
            ...
            <section className="page-hero hero-campus">
                <div className="hero-container hero-campus-grid">
                    <div className="hero-campus-copy relative z-10">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <ActionButton resource="tour" className="bg-primary text-white px-8 py-4 rounded-full font-bold flex items-center gap-3 hover:bg-secondary transition-colors shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                                College Virtual Tour <CirclePlay aria-hidden="true" className="hero-icon " />
                            </ActionButton>
                        </div>
                    </div>
                    <div className="hero-campus-media relative">
                        ...
                        <div className="hero-campus-stat absolute bg-white p-6 rounded-xl shadow-xl max-w-[200px] border-l-4 border-tertiary">
                ...
                <div aria-hidden="true" className="hero-campus-edge"></div>
            </section>
                ...
                <div className="max-w-7xl mx-auto px-8">
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-surface-container-lowest p-10 rounded-xl flex flex-col items-center text-center shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                            <span aria-hidden="true" className="material-symbols-outlined text-5xl text-tertiary mb-6">groups</span>
                        ...
                        <div className="bg-surface-container-lowest p-10 rounded-xl flex flex-col items-center text-center shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                            <span aria-hidden="true" className="material-symbols-outlined text-5xl text-tertiary mb-6">menu_book</span>
                        ...
                        <div className="bg-primary p-10 rounded-xl flex flex-col items-center text-center text-white shadow-[0px_20px_40px_rgba(25,28,29,0.06)] relative overflow-hidden">
                            ...
                            <span aria-hidden="true" className="material-symbols-outlined text-5xl text-tertiary-fixed mb-6">event_available</span>
            ...
            <section id="activities" className="py-24 bg-surface-container-low">
                <div className="max-w-7xl mx-auto px-8">
                    <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                        ...
                        <SectionLink to="/life" section="activities" className="text-primary font-bold border-b-2 border-primary-container pb-1 hover:text-secondary hover:border-secondary transition-colors whitespace-nowrap">View All Activities</SectionLink>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-6 md:h-[800px]">
                        ...
                        <div className="col-span-12 md:col-span-4 grid grid-rows-2 gap-6 h-full">
                            ...
                            <div className="rounded-2xl overflow-hidden relative group shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                                <img loading="lazy" decoding="async" alt="NSS" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCorz4aEaPdbB_0cs62Xiy-nsx4fPTwzcDPchno6mgx2C4uoE2TUV3W49W1COe9edzdzNbnn5ULzJg9_gnIE0IRDtMab09QbwXx5h_K2OlWxRskH1ikMPwMoDDSgVRXIqyoGc3Yh22nuMjul-9PmuqgcLSQ0OzQjb5dUnDgLc8KE6DqNcQYnBvP5GbkJO3RbDZFttHcolf2VfCmQCU1P177R8s-v_qg72WQXHGpZbmy24F4b4Fbim5uIB9BCrI2SqvDSthGS9Jns-JV" onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1559027615-cd4628902d4a?q=80&w=2669&auto=format&fit=crop"; }} />
                                <div className="absolute inset-0 bg-black/40 opacity-100 flex items-end p-6">
                                    <div className="text-white">
            ...
            <section className="py-24 bg-surface">
                <div className="max-w-4xl mx-auto px-8">
                    ...
                    <div className="mt-16 text-center">
                        <SectionLink to="/alumni" section="stories" className="bg-gradient-to-br from-primary to-primary-container text-white px-10 py-4 rounded-full font-bold uppercase tracking-widest text-xs hover:scale-105 transition-transform shadow-lg">Read More Stories</SectionLink>
                    </div>
                </div>
            </section>
