...
export default function Home() {
    return (
        <>
            ...
            <main className="snap-y-container">
                {/* Chapter 1 */}
                <section className="snap-section flex items-center justify-center" id="chapter-1">
                ...
                {/* Chapter 2 */}
                <section className="snap-section flex items-center" id="chapter-2">
                    <div className="absolute inset-0">
                ...
                {/* Chapter 3 */}
                <section className="snap-section flex items-center" id="chapter-3">
                    <div className="container mx-auto px-8 relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="group relative aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl mt-12 md:mt-24">
                ...
                {/* Chapter 4 */}
                <section className="snap-section flex items-center bg-[#000a1e]" id="chapter-4">
                    <div className="container mx-auto px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                            ...
                            <div className="glass-panel p-10 group hover:bg-tertiary transition-all duration-500 rounded-3xl mt-8">
                ...
                {/* Chapter 5 */}
                <section className="snap-section flex items-center justify-center" id="chapter-5">
                    <div className="absolute inset-0">
                    ...
                    <div className="container mx-auto px-8 relative z-10 text-center max-w-5xl">
                        ...
                        <span className="material-symbols-outlined text-7xl text-secondary opacity-50 mb-8">format_quote</span>
                ...
                {/* Final */}
                <section className="snap-section flex flex-col" id="final">
                    <div className="flex-grow flex items-center justify-center relative">
                        ...
                        <div className="relative z-10 text-center px-8">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
                                <button className="bg-white text-primary px-16 py-6 rounded-full font-bold text-2xl hover:bg-secondary hover:text-white transition-all transform hover:scale-105 active:scale-95 shadow-[0_0_50px_rgba(255,255,255,0.2)]">
                                    Apply Now
                                </button>
                                <button className="border border-white/30 text-white px-12 py-6 rounded-full font-bold text-xl hover:bg-white/10 transition-all">
                                    Talk to Admissions
                                </button>
                            </div>
                        </div>
