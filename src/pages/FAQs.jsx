                    ...
                    <div className="space-y-12">
                        ...
                        <div className="border-b border-outline-variant/30 pb-6">
                            <div className="flex items-center gap-4 mb-4">
                                <span aria-hidden="true" className="material-symbols-outlined text-secondary">how_to_reg</span>
                        ...
                        <div className="border-b border-outline-variant/30 pb-6">
                            <div className="flex items-center gap-4 mb-4">
                                <span aria-hidden="true" className="material-symbols-outlined text-secondary">menu_book</span>
                        ...
                        <div className="pb-6">
                            <div className="flex items-center gap-4 mb-4">
                                <span aria-hidden="true" className="material-symbols-outlined text-secondary">location_city</span>
                ...
                <div className="max-w-7xl mx-auto rounded-3xl bg-primary-container p-8 md:p-20 relative overflow-hidden shadow-2xl">
                    <div className="relative z-10 max-w-2xl">
                        ...
                        <div className="flex flex-wrap gap-6">
                            <ActionButton message="I have a question for the college support team." className="px-8 py-4 bg-tertiary-fixed text-black font-bold tracking-widest uppercase rounded-full hover:bg-white transition-colors text-xs">Contact Support</ActionButton>
                            <ActionButton resource="directory" className="px-8 py-4 border border-outline-variant/30 text-white font-bold tracking-widest uppercase rounded-full hover:bg-white/10 transition-colors text-xs">Campus Directory</ActionButton>
                        </div>
                    </div>
                    {/* Abstract Texture */}
