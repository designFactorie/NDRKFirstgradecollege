...
export default function Academics() {
    return (
        <main id="main-content" tabIndex={-1} className="page-shell ">
            {/* Hero Section */}
            <section className="page-hero hero-photo hero-academics">
                ...
                <div className="hero-container container mx-auto px-8 relative z-10 ">
                    <div className="max-w-3xl">
                        <span className="uppercase tracking-[0.1rem] text-tertiary-fixed font-bold mb-4 block">Institutional Excellence</span>
                        <h1 className="font-headline text-4xl md:text-6xl font-bold mb-8 leading-tight text-white">We live at the intersection of <br className="hero-break" /><span className="italic text-secondary-fixed-dim">teaching and doing.</span></h1>
                        ...
                        <div className="hero-stats grid grid-cols-3 border-t border-white/20">
                            <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div className="bg-surface-container-lowest p-8 rounded-xl flex flex-col h-full shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:-translate-y-2 transition-transform duration-300">
                            <div className="w-12 h-12 rounded-lg bg-primary-container flex items-center justify-center mb-6">
                                <span aria-hidden="true" className="material-symbols-outlined text-tertiary-fixed">account_balance</span>
                            </div>
                            ...
                            <SectionLink to="/courses" section="curriculum-bcom" className="flex items-center gap-2 text-secondary font-bold group-hover:gap-4 transition-all">
                                Learn More <span aria-hidden="true" className="material-symbols-outlined">arrow_forward</span>
                            </SectionLink>
                        </div>
                        {/* MCom */}
                        <div className="bg-surface-container-lowest p-8 rounded-xl flex flex-col h-full shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:-translate-y-2 transition-transform duration-300 border-t-4 border-tertiary">
                            <div className="w-12 h-12 rounded-lg bg-primary-container flex items-center justify-center mb-6">
                                <span aria-hidden="true" className="material-symbols-outlined text-tertiary-fixed">analytics</span>
                            </div>
                            ...
                            <ActionButton resource="syllabus" className="flex items-center gap-2 text-secondary font-bold group-hover:gap-4 transition-all">
                                View Syllabus <span aria-hidden="true" className="material-symbols-outlined">arrow_forward</span>
                            </ActionButton>
                        </div>
                        {/* BCA */}
                        <div className="bg-surface-container-lowest p-8 rounded-xl flex flex-col h-full shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:-translate-y-2 transition-transform duration-300">
                            <div className="w-12 h-12 rounded-lg bg-primary-container flex items-center justify-center mb-6">
                                <span aria-hidden="true" className="material-symbols-outlined text-tertiary-fixed">terminal</span>
                            </div>
                            ...
                            <SectionLink to="/courses" section="curriculum-bca" className="flex items-center gap-2 text-secondary font-bold group-hover:gap-4 transition-all">
                                Learn More <span aria-hidden="true" className="material-symbols-outlined">arrow_forward</span>
                            </SectionLink>
                        </div>
                        {/* BBA */}
                        <div className="bg-surface-container-lowest p-8 rounded-xl flex flex-col h-full shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:-translate-y-2 transition-transform duration-300">
                            <div className="w-12 h-12 rounded-lg bg-primary-container flex items-center justify-center mb-6">
                                <span aria-hidden="true" className="material-symbols-outlined text-tertiary-fixed">business_center</span>
                            </div>
            ...
            <section className="py-24 px-8 bg-primary overflow-hidden">
                <div className="container mx-auto">
                    <div className="flex flex-col md:flex-row items-center justify-between mb-16 border-b border-white/10 pb-12">
                        ...
                        <ActionButton purpose="visit" message="I would like to book a campus tour." className="bg-tertiary-fixed text-on-tertiary-fixed px-8 py-4 rounded-full font-bold hover:bg-secondary transition-colors whitespace-nowrap">Book a Campus Tour</ActionButton>
                    </div>
                    ...
                    <div className="grid grid-cols-12 gap-6">
                        ...
                        <div className="col-span-12 md:col-span-7 aspect-[16/11] md:aspect-auto md:h-full relative group rounded-xl overflow-hidden shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                            <img loading="lazy" decoding="async" alt="Library" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuAPX2pJo6mmjYdeE8yAQGTdvWRzrrwtesstobpeE7An6WUu7WJldbE6w0kxGgVkCq8aFheAWMHcaM0RGYOsCmNldm-FGX0HngQ6nwy5i38-pFUVHqZZSImVKMqUpf1xC2hF5SXuydSsNDxdPCd2gZesTwnbQcnRFPiET9IyFy-JSDllDbzzKylL5rVt4B5LLz1rYNPf88GmREcB3AUOiTI4XhfkbiuNd26tjsN2F1PFB65fR-f8J6HvJXOepGUhEiSby88rzSdkVa7D" />
                        ...
                        <div className="col-span-12 md:col-span-5 grid grid-rows-2 gap-6">
                            ...
                            <div className="relative group rounded-xl overflow-hidden aspect-video shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                                <img loading="lazy" decoding="async" alt="Computer Lab" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCUXBjhMAqcnvhv1e7xNtAnTQL6eq5GYoi0_IiDKcIbFTk3vA6WC7ZdIYQFR58lPSIdJuWOKlGgASBzRiS5jyE-eKgkwk5mtV4il38vrrLDbgWNGz0e5lGfi2CWXHD-26y_xv6kDtgueB3nRXHe81mKSU6VGP5_1nz6Vwx7eE6OE0S11Wv2So7HfAEORhXiT14P2PWbuAGYzuJmMk6BlCpqIYxYFUs5dJU3QMFL4EAxQyu-kJFOOEnayDtufkKoQois3D68YLBMYznZ" />
                            ...
                            {/* Hostel */}
                            <div className="relative group rounded-xl overflow-hidden aspect-video shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                                <img loading="lazy" decoding="async" alt="Hostel" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuB_OTaYyd8UG4MYKQe8AcnqDDOyV-Srn6dqQ40k6OHyOQTFyPocbAlmO3Y9P--10xgx-Ny2V0DxF0xaygkiA5nzdKBvZmvwQib9_8V9RINl6fin0J9kM14Ymj7UG9mrVM9y9Ewils4c-HYGw76zVewXeRX5he6xO0SxUJfFGUiLvYsOesPkk_Xb8UkWZEFWdDwLtLQ767ZiWL5sEYYIjfk6JEg0vNJHQHr86-wkhddLxzvvT4Ttn4nxi_Z1cXReGIkoLTUcH_K8U2t3" />
                                <div className="absolute bottom-0 left-0 p-6 w-full bg-gradient-to-t from-black/80 via-black/40 to-transparent">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        ...
                        <div className="aspect-video relative group rounded-xl overflow-hidden shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                            <img loading="lazy" decoding="async" alt="Classroom" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuBqAaS9_Yfs_a3U4ghvXj-P62KN2mRvozUNNvZRAWG32QBl5r8EK9wi97MSbAHZ-67YmUCWhjr_IuYdUB4ktRiiWQvvS-1nEC9nqHXbux25flIMteICqgPf1QkkMV5PM3RAfkeIcOw-l7aBcWzT0rof9M4DsxpTl8PDcGB39iiFSMNU9Esorv5GxCZ9veQz6bodW4jN-8Fcq8YZgXd5jym7Bo9aZOn--rY9netbYTRl_-S4mLkTM5nKJN2NjelKJ4PJysIaoYvZo3if" />
                            <div className="absolute bottom-0 left-0 p-6 w-full bg-gradient-to-t from-black/80 via-black/40 to-transparent">
                        ...
                        {/* Playground */}
                        <div className="aspect-video relative group rounded-xl overflow-hidden shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                            <img loading="lazy" decoding="async" alt="Playground" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-700" src="https://lh3.googleusercontent.com/aida-public/AB6AXuD34W2zL6uA9s2aZ-qK7n5Ntz8O-Wv9Z3U5a7LqH7kI1c2K-R1bKxZ5Y-v-5i6jC2hLq_rW9L9B4w9B4G_R1K6wY3L_3rW6B3J6R7U7T2Y0B6P2Q9F6P7Y1T6C8D8T2K-B8P-M6M-B" onError={(e) => { e.target.src = "https://images.unsplash.com/photo-1575361204480-aadea25e6e68?q=80&w=2671&auto=format&fit=crop"; }} />
                            <div className="absolute bottom-0 left-0 p-6 w-full bg-gradient-to-t from-black/80 via-black/40 to-transparent">
            ...
            <section className="py-24 px-8 bg-surface">
                <div className="container mx-auto bg-surface-variant p-8 md:p-16 rounded-3xl flex flex-col md:flex-row items-center justify-between shadow-[0px_20px_40px_rgba(25,28,29,0.06)]">
                    ...
                    <div className="w-full md:w-auto flex flex-col md:flex-row gap-4">
                        <input aria-label="Your academic email" className="bg-white border-none rounded-full px-8 py-4 w-full md:w-80 focus:ring-2 focus:ring-secondary" placeholder="Your academic email" type="email" />
                        <ActionButton resource="subscribe" className="bg-primary text-white px-8 py-4 rounded-full font-bold hover:bg-secondary transition-colors shrink-0">Subscribe</ActionButton>
                    </div>
                </div>
            </section>
