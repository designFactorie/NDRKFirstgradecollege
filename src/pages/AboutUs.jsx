...
export default function AboutUs() {
    return (
        <main id="main-content" tabIndex={-1} className="page-shell ">
            {/* Hero Section */}
            <section className="page-hero hero-photo hero-story">
                ...
                <div className="hero-scroll-hint absolute left-1/2 -translate-x-1/2 animate-bounce">
                    <ChevronDown aria-hidden="true" className="hero-icon " />
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
                        ...
                        <div className="lg:col-span-5 relative">
                            <div className="rounded-xl overflow-hidden shadow-[0px_20px_40px_rgba(25,28,29,0.06)] bg-white/5">
                                <img loading="lazy" decoding="async" alt="A Tradition of Excellence" className="w-full h-auto block" src="/assets/images/tmpt.webp" />
                            </div>
                ...
                <div className="container mx-auto px-8">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-surface-container-lowest p-8 md:p-12 rounded-xl shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:bg-primary transition-colors duration-500">
                            <span aria-hidden="true" className="material-symbols-outlined text-secondary text-5xl mb-8 group-hover:text-tertiary-fixed transition-colors">rocket_launch</span>
                        ...
                        <div className="bg-surface-container-lowest p-8 md:p-12 rounded-xl shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:bg-primary transition-colors duration-500">
                            <span aria-hidden="true" className="material-symbols-outlined text-secondary text-5xl mb-8 group-hover:text-tertiary-fixed transition-colors">visibility</span>
                        ...
                        <div className="bg-surface-container-lowest p-8 md:p-12 rounded-xl shadow-[0px_20px_40px_rgba(25,28,29,0.06)] group hover:bg-primary transition-colors duration-500">
                            <span aria-hidden="true" className="material-symbols-outlined text-secondary text-5xl mb-8 group-hover:text-tertiary-fixed transition-colors">verified_user</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="group">
                            <div className="aspect-[3/4] rounded-xl overflow-hidden mb-6 bg-surface-container-highest relative">
                                <img loading="lazy" decoding="async" alt="Chairman Portrait" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" src="/assets/images/chairman.webp" />
                    ...
                    <div className="bg-gradient-to-br from-primary to-primary-container rounded-3xl p-12 md:p-20 text-center relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <div className="flex flex-col md:flex-row gap-6 justify-center">
                                <ActionButton resource="prospectus" className="bg-tertiary-fixed text-black px-10 py-4 rounded-full font-bold text-lg hover:bg-secondary transition-all">Download Prospectus</ActionButton>
                                <ActionButton purpose="visit" message="I would like to schedule a campus visit." className="bg-transparent border border-white/20 text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-white/10 transition-all">Schedule a Campus Visit</ActionButton>
                            </div>
                        </div>
                        <div className="absolute top-0 right-0 opacity-10 pointer-events-none">
                            <span aria-hidden="true" className="material-symbols-outlined text-[30rem]">school</span>
                        </div>
                    </div>
                </div>
            </section>
